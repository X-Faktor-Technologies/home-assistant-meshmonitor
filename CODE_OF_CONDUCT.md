...
using an official email address, posting through an official social media
account, or acting as an appointed representative at an event.

## Enforcement

Report abusive, harassing, or otherwise unacceptable behavior privately
through GitHub private vulnerability reporting, using the subject "Code of
conduct," after that route is enabled. Before publication, arrange a private
channel with the project owner. Do not include mesh credentials or private
operational data in a conduct report.
...
avoiding interactions in community spaces and external channels like social
...
with the community for a specified period. No public or private interaction
